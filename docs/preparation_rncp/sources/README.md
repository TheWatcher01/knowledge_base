...
- **[`references-bibliographiques.md`](references-bibliographiques.md)** - Version
  ...
  - Citations exactes et chiffres vérifiables

## 🎯 Utilisation

Les sources sont **référencées dans le document principal** via un système de liens cliquables :

```markdown
Les ingénieurs passent **2h/jour à chercher de l'information** existante ¹
```
...
| Organisation | Type de source | Sujet |
|-------------|----------------|-------|
| McKinsey Global Institute | Étude (2023) | Productivité et recherche d'information |
| Tech-Clarity | Enquête (2 000+ ingénieurs) | Gestion des données techniques |
| Harvard Business Review | Article | Perte d'expertise lors des départs |
| LumApps | Étude RH (2025) | Durée d'onboarding |
| Airbus | Article institutionnel (2024) | IA générative en aéronautique |
| TotalEnergies | Cas d'usage RAG | Assistant interne Jafar |
| Atos | Interview (2025) | Recrutement compétences RAG |
| Région Occitanie | Annonce officielle (2024) | Plan IA 60 M€ |
| Sopra Steria Next | Étude marché (2024) | Marché IA générative |
